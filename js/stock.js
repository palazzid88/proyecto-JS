...
// declaración de stock productos a través de una array deobjetos literales:

// let stockProductos = [
//     {id: 1, nombre: "banana", tipo: "fruta", descripcion: "Banana de ecuador", precio: 180, unidad: "kg", img: './img/banana.jpg'},
//     {id: 2, nombre: "manzana", tipo: "fruta", descripcion: "Manzana roja", precio: 190, unidad: "kg", img: './img/manzana.jpg'},
//     {id: 3, nombre: "frutilla", tipo: "fruta", descripcion: "Frutilla sabrosas", precio: 380, unidad: "kg", img: './img/frutilla.jpg'},
//     {id: 4, nombre: "naranja", tipo: "fruta", descripcion: "naranja de ombligo", precio: 200, unidad: "kg", img: './img/naranja.jpg'},
//     {id: 5, nombre: "kiwi", tipo: "fruta", descripcion: "Kiwi de Nueva Zelanda", precio: 340, unidad: "kg", img: './img/kiwi.jpg'},
//     {id: 6, nombre: "pera", tipo: "fruta", descripcion: "Pera de Chubut", precio: 150, unidad: "kg", img: './img/pera.jpg'},
//     {id: 7, nombre: "berenjena", tipo: "verdura", descripcion: "berenjena grande", precio: 250, unidad: "kg", img: './img/berenjena.png'},
